...
* Il est nécessaire de posséder une **clé API Google Maps** à indiquer dans le fichier local.properties sous la forme: MAPS_API_KEY=KEY_VALUE où KEY_VALUE est à remplacer par la valeur de la clé.
### Les permissions
